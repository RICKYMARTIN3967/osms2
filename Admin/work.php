        ...
        echo "<table class='table'>";
            echo "<thead>";
                echo "<tr>";
                    ...
                    echo "<th scope='col'>Technicians</th>";
                ...
                echo "<tr>";
                    ...
                    echo "<td>";
                        echo "<form action='viewassignwork.php' method='POST' class='d-inline mr-2'>";
                            echo "<input type='hidden' name='id' value='{$row['request_id']}'><button class='btn btn-warning' type='submit' name='view' vlaue='View'><i class='far fa-eye'></i></button>";
                        echo "</form>";
                        echo "<form action='' method='POST' class='d-inline'>";
                            echo "<input type='hidden' name='id' value='{$row['request_id']}'><button class='btn btn-secondary' type='submit' name='delete' vlaue='Delete'><i class='far fa-trash-alt'></i></button>";
                        echo "</form>";
                    echo "</td>";
                echo "</tr>";
            }
