...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="pava" id="pava" value="<?php if(isset($row['pava'])){echo $row['pava'];} ?>" onkeypress="isInputNumber(event)">
        </div>
        <div class="form-group">
        ...
        <div class="text-center">
            <button type='submit' class='btn btn-danger mr-3' id='pupdate' name='pupdate'>Update</button>
