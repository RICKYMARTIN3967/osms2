...
if(isset($_REQUEST['psubmit'])) {
    if(($_REQUEST['cname']=="") || ($_REQUEST['cadd']=="") || ($_REQUEST["pname"]=="") || ($_REQUEST['pquantity']=="") || ($_REQUEST['psellingcost']=="") || ($_REQUEST["totalcost"]=="") || ($_REQUEST['selldate']=="")) {
        ...
        if($conn->query($sql)==TRUE) {
            $genid = mysqli_insert_id($conn);     //// gives the last inserted id
            session_start();
            $_SESSION['myid'] = $genid;
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="pava" id="pava" value="<?php if(isset($row['pava'])){echo $row['pava'];} ?>" onkeypress="isInputNumber(event)" readonly>
        </div>
        ...
        <div class="text-center">
            <button type='submit' class='btn btn-danger mr-3' id='psubmit' name='psubmit'>Submit</button>
